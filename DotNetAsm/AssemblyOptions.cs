...
namespace DotNetAsm
{
    ...
    public class AssemblyOptions
    {
        ...
        public AssemblyOptions(
            IEnumerable<string> source_files = null,
            ...
            bool quiet = false,
            bool verboseDasm = false,
            bool werror = false,
            bool noWarn = false,
            bool caseSensitive = false,
            bool noAssembly = false,
            bool noSource = false,
            bool printVersion = false,
            bool noDisassembly = false,
            bool warnLeft = false
        )
        {
            _source = (List<string>) source_files ?? new List<string>();
            _defines = (List<string>) defines ?? new List<string>();
            _arch = arch;
            _cpu = cpu;
            ...
            _verboseDasm = verboseDasm;
            _werror = werror;
            _noWarn = noWarn;
            _warnLeft = warnLeft;
            _noDisassembly = noDisassembly;
            _noSource = noSource;
            _noAssembly = noAssembly;
            _quiet = quiet;
